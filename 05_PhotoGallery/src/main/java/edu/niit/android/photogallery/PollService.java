...
//    private static final int POLL_INTERVAL = 1000 * 60; // 60秒
    ...
    public static final String ACTION_SHOW_NOTIFICATION =
            "edu.niit.android.photogallery.SHOW_NOTIFICATION";
    public static final String PERM_PRIVATE = "edu.niit.android.photogallery.PRIVATE";
    ...
    protected void onHandleIntent(@Nullable Intent intent) {
        ...
        if(query == null) {
            items = new FlickrFetch().fetchRecentPhotots();
        } else {
